(define (problem viaje-ext3-2)
    ...
    (:objects
        madrid barato1 barato2 caro1 caro2 - ciudad
        h-madrid h-b1 h-b2 h-c1 h-c2 - hotel
    )
    ...
    (:init
        ...
        (conectada madrid barato1)
        (conectada barato1 caro1)

        ;; Hoteles caros
        (conectada madrid caro2)

        (= (ciudades-visitadas) 0)
        (= (dias-totales) 0)
        (= (presupuesto-gastado) 0)

        (= (dias-en madrid) 0) (= (dias-en barato1) 0) (= (dias-en barato2) 0)
