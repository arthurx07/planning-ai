(define (problem viaje-ext4-1)
    ...
    (:objects
        madrid roma florencia zaragoza murcia - ciudad
        h-madrid h-roma h-flo h-zar h-mur - hotel
    )
    ...
    ;; Resultado: El presupuesto se come al interés. El planificador elegirá Low-Cost.
